...
aws s3api create-bucket --bucket xfusion-s3-26590

aws s3api put-public-access-block --bucket xfusion-s3-26590 --public-access-block-configuration file://policy.json
