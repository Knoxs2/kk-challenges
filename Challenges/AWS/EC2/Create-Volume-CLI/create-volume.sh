...
aws ec2 create-volume --size 2 --volume-type gp3 --tag-specifications 'ResourceType=volume,Tags=[{Key=Name,Value=devops-volume-t1q4}]' --availability-zone us-east-1a
